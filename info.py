...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ' -2431735139'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-2319983283')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://joansina637:JIUVGgiRgXfN2CBO@cluster0.hetfa.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0)   # IF Multiple Database Is False Then Fill Only This Database Url.
